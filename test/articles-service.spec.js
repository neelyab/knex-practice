...
describe('article services object', function () {
    let db 
    let testArticles = [
         {
           id: 1,
    ...
    context(`Given 'blogful_articles' has data`, () => {
      ...
      context(`Given 'blogful_articles' has no data`, () => {
        ...
        it('insertArticle() inserts a new article and resolves it with a new id',()=>{
            const newArticle = {
...
//     it(`resolves all articles from blogful articles`, () => {
